    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<CodeSmellCategory>().HasData(
                new CodeSmellCategory { Id = bloaterCategoryId, Name = "Bloaters", Description = "Bloaters are code, methods, and classes that become excessively large and difficult to manage. These issues typically develop gradually as the program evolves, especially if no effort is made to address them.", ImageUrl= "https://cosmellrefine.blob.core.windows.net/media/bloaters.png" },
                new CodeSmellCategory { Id = ooAbusersCategoryId, Name = "Object Orientation Abusers", Description = "All these code smells result from the incomplete or incorrect application of object-oriented programming principles.", ImageUrl= "https://cosmellrefine.blob.core.windows.net/media/object_orientation_abusers.png" },
                new CodeSmellCategory { Id = changePreventersCategoryId, Name = "Change Preventers", Description = "These code smells indicate that changing one part of the code requires multiple changes elsewhere, making program development more complex and costly.", ImageUrl= "https://cosmellrefine.blob.core.windows.net/media/change_preventers.png" },
                new CodeSmellCategory { Id = dispensablesCategoryId, Name = "Dispensables", Description = "A dispensable is an unnecessary element whose removal would make the code cleaner, more efficient, and easier to understand.", ImageUrl= "https://cosmellrefine.blob.core.windows.net/media/dispensables.png" },
                new CodeSmellCategory { Id = couplersCategoryId, Name = "Couplers", Description = "All the smells in this group contribute to excessive coupling between classes or result from replacing coupling with excessive delegation.", ImageUrl= "https://cosmellrefine.blob.core.windows.net/media/couplers.png" }
            );
